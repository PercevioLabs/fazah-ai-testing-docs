...
```text
Cover software testing and requirements engineering.
```
...
```text
About 20 marks, and include a teacher answer key.
```
...
```text
One of these is too easy — replace it with a harder one.
```
