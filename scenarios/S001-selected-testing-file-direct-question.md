...
```text
Add the distinction between inspections and testing to that.
```
...
```text
Give me one weather-station or Mentcare example for each of those four terms.
```
...
```text
Turn all of this into four short quiz questions with answers.
```
...
```text
Now give me a student version of those four questions with no answers.
```
...
```text
Which course file did you use for all of this?
```
