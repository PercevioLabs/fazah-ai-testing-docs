...
```text
Use the chapter about testing and explain the three stages of development testing.
```
...
```text
Give a short example for each of those three levels.
```
...
```text
Now make three questions on this.
```
...
```text
Add answers to the three questions.
```
...
```text
Give me a student version without the answers.
```
