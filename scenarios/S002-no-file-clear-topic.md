...
```text
Explain development testing, release testing, and user testing.
```
...
```text
Go deeper on release testing — I want the black-box angle and who actually runs it.
```
...
```text
Now compare release testing and user testing in a table.
```
...
```text
Which course file did all of this come from?
```
...
```text
Make three review questions from that table, with answers.
```
...
```text
Give me a student version of those three questions with no answers.
```
