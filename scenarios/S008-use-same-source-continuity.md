...
```text
Create a short quiz on software testing.
```
...
```text
Use the same source and create student notes.
```
...
```text
Now give me a one-page version.
```
...
```text
Add three review questions based on those notes.
```
...
```text
Turn those three questions into a student version with no answers.
```
...
```text
Make a five-slide outline from the notes.
```
...
```text
Now give me a teacher version of the three questions with answers.
```
