...
```text
Add a simple analogy so beginners can picture it.
```
...
```text
List the key roles plainly — product owner, ScrumMaster, and the development team.
```
...
```text
Make four beginner questions on this.
```
...
```text
Give me a student version of those questions.
```
