...
[EVIDENCE-NAMING.md](./EVIDENCE-NAMING.md) and log rows in
[AUDIT-PROGRESS-TEMPLATE.csv](./AUDIT-PROGRESS-TEMPLATE.csv) and
[TURN-RESULTS-TEMPLATE.csv](./TURN-RESULTS-TEMPLATE.csv).

For the whole workflow, see [CONTEXT-DIAGRAM.md](./CONTEXT-DIAGRAM.md).
