...
```text
what are the 4 essential attributes of good software, give a short explanation of each
```
...
```text
make 4 questions from this, one per attribute
```
...
```text
gimme a student version of those 4 qs, no answers
```
