...
```text
explain unit, component & system testing, and give a short example of interface misuse, interface misunderstanding, and a timing error
```
...
```text
make 5 questions across these topics
```
