...
```text
make exactly 10 questions on software testing w answers
```
...
```text
ok now reorder easiest to hardest, dont change the content
```
...
```text
make the last 3 scenario based
```
...
```text
n a teacher key w explanations
```
...
```text
add a 3 question bonus section
```
...
```text
confirm the 10 core qs are still there n tell me which file u used
```
