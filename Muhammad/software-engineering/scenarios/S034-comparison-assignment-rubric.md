...
```text
need an assignment comparing plan driven and agile development
```
...
```text
turn the grading criteria into a 4 level rubric n add a late submission note
```
...
```text
add an example of a strong answer, teachers only
```
...
```text
give me a final inventory of the assignment, rubric, versions n the sources you used
```
