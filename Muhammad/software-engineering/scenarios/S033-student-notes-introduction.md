...
```text
make student facing notes from this lecture
```
...
```text
no, remove any teacher facing language
```
...
```text
add a glossary n keep the final version to 2 pages
```
...
```text
confirm which file u used n who the notes are for
```
