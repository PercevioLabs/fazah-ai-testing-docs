...
```text
make a concise revision guide for this course, organized by lecture
```
...
```text
add 5 cross-chapter connections, dont rewrite the guide
```
...
```text
now add 2 key definitions to each lecture section
```
...
```text
now a 10-question cumulative quiz spanning all 5 decks
```
