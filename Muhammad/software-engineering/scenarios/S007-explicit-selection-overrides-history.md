...
```text
ok now explain test-driven development
```
...
```text
keep using the Testing file, explain unit vs component testing
```
...
```text
make 5 questions from the Testing file
```
